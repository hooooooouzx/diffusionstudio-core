...
**I updated v1.6 version and fixed the currentframe bug. Here is the source code: https://github.com/hooooooouzx/diffusionstudio-core**
...
```sh
npm install @plotvideo/diffusionstudio
```
